...
%%
%// draw the graph
s = [0, 0, 0, 1, 1, 2, 2, 3, 3, 4, 5, 6, 7, 7, 8, 8, 9, 9, 10, 11, 11, 12, 12, 14, 14, 15, 15, 16, 17, 17, 17, 18, 19, 19, 20, 22, 23, 23]+1;
t = [1, 2, 3, 4, 2, 5, 6, 7, 8, 5, 9, 10, 6, 11, 7, 11, 12, 13, 13, 14, 15, 16, 23, 15, 18, 19, 20, 21, 12, 19, 23, 17, 20, 23, 22, 21, 21, 22]+1;
G = graph(s, t);
figure;
plot(G);
%%
